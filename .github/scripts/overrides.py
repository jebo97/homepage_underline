...
KINDS = ("force_catalog", "naver_query", "skip", "author", "title", "title_regex", "author_prefix", "book_author", "publisher")
    ...
    for r in rows:
        ...
        if k == "skip":
            ...
            try:
                ...
                pass
        elif k in ("force_catalog", "naver_query", "author", "title", "author_prefix", "book_author", "publisher"):
            out[k][p] = v
    return out
